...
public class Film extends AbstractEntity<Film> implements Serializable {
	...
	public void addCategory(int id) {
		addCategory(new Category(id, description, filmCategories));
	}
	...
	public void removeCategory(int id) {
		removeCategory(new Category(id, description, filmCategories));
	}
	...
	public Film merge(Film target) {
		// BeanUtils.copyProperties(this, target, "filmId" , "filmActors",
		// "filmCategories");
		target.title = title;
